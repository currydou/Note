...
import com.yodoo.android.baseutil.base.DefaultProgressDialog;
import com.yodoo.android.baseutil.base.ProgressDialog;
import com.yodoo.android.baseutil.http.BaseUrl;
import com.yodoo.android.baseutil.http.GlobalHttpHandler;
import com.yodoo.android.baseutil.imageloader.BaseImageLoaderStrategy;
import com.yodoo.android.baseutil.imageloader.glide.GlideImageLoaderStrategy;
...
//    private ClientModule.RxCacheConfiguration mRxCacheConfiguration;
    ...
    private AppModule.DataBase mDataBase;
...
//        this.mRxCacheConfiguration = builder.rxCacheConfiguration;
        ...
        this.mDataBase = builder.dataBase;
        this.mProgressDialog = builder.progressDialog;
    }
    ...
    File provideCacheFile(Application application) {
        return mCacheFile == null ? DataUtil.getCacheFile(application) : mCacheFile;
    }
...
//    }
    ...
    @Singleton
    @Provides
    AppModule.DataBase provideDataBase(final Application application) {
        if (mDataBase == null) {
            return new AppModule.DataBase() {
                @Override
                public String getDataBaseName() {
                    return application.getString(R.string.b_database_name);
                }
            };
        } else {
            return mDataBase;
    ...
    ProgressDialog provideProgressDialog() {
        if (mProgressDialog == null) {
            mProgressDialog = new DefaultProgressDialog();
        }
...
//        private ClientModule.RxCacheConfiguration rxCacheConfiguration;
        ...
        private AppModule.DataBase dataBase;
        ...
        public Builder progressDialog() {//处理所有Rxjava的onError逻辑
            this.progressDialog = new DefaultProgressDialog();
            return this;
        }
        ...
        public Builder dataBase(AppModule.DataBase dataBase) {
